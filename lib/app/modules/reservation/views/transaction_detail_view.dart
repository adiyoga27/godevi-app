...
class TransactionDetailView extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      bottomSheet: _buildBottomActions(context, transaction),
    );
  }
  ...
  Widget? _buildBottomActions(
    ...
    final controller = Get.find<godevi_app.ReservationController>();
        ...
        children: [
          Expanded(
            child: OutlinedButton(
              onPressed: () => controller.cancelTransaction(transaction),
          ...
          Expanded(
            child: ElevatedButton(
              onPressed: () => controller.proceedToPayment(transaction),
